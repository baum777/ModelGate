...
## [2026-05-16] frontend-shell-refactor-extraction | extracted shell routing contract, landing surface, shell controls/icons, and stateful console shell from `App.tsx`; updated source-based tests to assert new module boundaries while preserving behavior and authority semantics [[../web/src/App.tsx]] [[../web/src/lib/shell-routing.ts]] [[../web/src/components/shell/ConsoleShell.tsx]] [[../web/src/components/landing/LandingPage.tsx]] [[../web/src/components/shell/ShellControls.tsx]] [[../web/src/components/shell/ShellIcons.tsx]] [[../web/src/hooks/useCrossTabCommands.ts]] [[../web/test/app-localization.test.ts]] [[../web/test/mobile-redesign.test.ts]] [[../web/test/floating-companion.test.ts]] [[../web/test/github-page.test.ts]] [[../web/test/matrix-page.test.ts]]
