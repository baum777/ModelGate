...
export function createEnv(source: NodeJS.ProcessEnv = process.env): AppEnv {
  ...
  return {
    ...
    OPENROUTER_API_KEY_QWEN3_CODER: parsed.OPENROUTER_API_KEY_QWEN3_CODER,
    OPENROUTER_API_KEY_GPT_OSS_120B_PLANNER: parsed.OPENROUTER_API_KEY_GPT_OSS_120B_PLANNER,
    OPENROUTER_API_KEY_NEMOTRON_3_SUPER_120B: parsed.OPENROUTER_API_KEY_NEMOTRON_3_SUPER_120B,
    OPENROUTER_BASE_URL: parsed.OPENROUTER_BASE_URL,
    OPENROUTER_MODEL: parsed.OPENROUTER_MODEL,
